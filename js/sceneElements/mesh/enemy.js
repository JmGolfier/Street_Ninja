...
var enemyModel = gameEngine.models[Constants.Models.Enemy];
var mesh = createMesh(enemyModel);
...
function createMesh(enemyModel) {
    var geometry = enemyModel.geometry;

    geometry.computeMorphNormals();
    var mat = new THREE.MeshLambertMaterial({
        map: THREE.ImageUtils.loadTexture(Constants.Paths.Skins.Enemy),
